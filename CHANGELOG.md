...
* add -c flag for phoenix ([b6c0cb6](https://github.com/nevillionaire/puter/commit/b6c0cb6abc1c29846b4b7e696812476bea24bbc7))
* add an 'Upload' button at the bottom of `OpenFilePicker` ([54ae69b](https://github.com/nevillionaire/puter/commit/54ae69b7b76016307c3b92437ca06dc2aa1eddb9))
* add config for blocked email domains ([955b087](https://github.com/nevillionaire/puter/commit/955b087297f829b11b82dc9bd79a0e03721c5f33))
* add connectToInstance method to puter.ui ([62634b0](https://github.com/nevillionaire/puter/commit/62634b0afe4d33da08768975322d4deb23041442))
* add error handling to the share flow ([b5bb95e](https://github.com/nevillionaire/puter/commit/b5bb95e2d7f6021a6341e26cf15d5449ada48830))
* add extension API for modules ([14d45a2](https://github.com/nevillionaire/puter/commit/14d45a27edb99f63b4f6e010221e3a0880ae246d))
* add method to list models ([fd86934](https://github.com/nevillionaire/puter/commit/fd86934bc9021541810447cf7e2a5f33b3e283b3))
* add puter.auth.whoami() ([da0022a](https://github.com/nevillionaire/puter/commit/da0022abf0f880c7b52d2cd937ef9d1298fc09cc))
* add puter.log ([755736e](https://github.com/nevillionaire/puter/commit/755736edee9baa783be9b7d96083d908a2f2f750))
* add streaming to XHR driver client ([7600d9b](https://github.com/nevillionaire/puter/commit/7600d9b07c5b719d529f8a48c38d9178efefa266))
* add support for `fadeIn` effect for `UIWindow` ([13248a9](https://github.com/nevillionaire/puter/commit/13248a99bfa318e84cb99e2954a5f46805eda34f))
* add support for extensions ([b018571](https://github.com/nevillionaire/puter/commit/b018571a86f4114eab9b5edde4ecd87e343d22a7))
* **ai:** add xAI grok-beta ([28adcf5](https://github.com/nevillionaire/puter/commit/28adcf533fd867dfdf3bda0007753e65c91ff5e5))
* allow `launchApp` to open explorer at a specific path ([8fefd4a](https://github.com/nevillionaire/puter/commit/8fefd4a61f0005d4f3ec2e43f7249f3edd91c837))
* Allow apps to toggle `credentialless` via Dev Center ([af511c0](https://github.com/nevillionaire/puter/commit/af511c05e3ddddcce661c5406d5c831a21689608))
* allow passing cli args via url ([5317adf](https://github.com/nevillionaire/puter/commit/5317adf8a4961be3f0ca2a8c403c922633f934fa))
* **api:** add /lsmod ([32f0edb](https://github.com/nevillionaire/puter/commit/32f0edb93a8fb0c33b0614b99c7fc439c8f6afc9))
* **backend:** add comments for fsentries ([db79a72](https://github.com/nevillionaire/puter/commit/db79a72daab5460bc8e24f6e16c6280291b2f6fe))
* collapsible sidebar menu in Dev Center ([1056231](https://github.com/nevillionaire/puter/commit/1056231004a629f3f76f2525ec7d83b67d3d7fa5))
* customize the order of Explorer sidebar items ([ff30de1](https://github.com/nevillionaire/puter/commit/ff30de1d6947e4692b5cf0da2e19ab37aacf1ec8))
* first extension that implements a custom user options menu ([fc5e15f](https://github.com/nevillionaire/puter/commit/fc5e15f2a6d4eb5e5847fa7f2dd87b1fa382fc7c))
* handle `notif.ack` in desktop ([a6650ee](https://github.com/nevillionaire/puter/commit/a6650ee2d8074aeb7c476e5572334853f1b6d7e8))
* Implement profile pictures ([0885937](https://github.com/nevillionaire/puter/commit/0885937f033caf35503eeb9e65bb390952992faf))
* in Share window, display access level next to recipient ([cf4b6aa](https://github.com/nevillionaire/puter/commit/cf4b6aa1c24d936f9a42ca1e2945eea40939c970))
* progress indicator for emulator ([08601ae](https://github.com/nevillionaire/puter/commit/08601ae2af7b1f564690e6a9cae7e689cb7ba48a))
* **puterai:** add claude ([d009cd0](https://github.com/nevillionaire/puter/commit/d009cd0aaff645a24d37085ed41c55fe296a5722))
* **puterai:** add groq ([53e7a91](https://github.com/nevillionaire/puter/commit/53e7a91f1800b60b48575a6e41d96d2ccbd6d362))
* **puterai:** add mistral ([055c628](https://github.com/nevillionaire/puter/commit/055c628afd2e33589d3dc66c52934505143eafd4))
* **puterai:** add streaming ([9d5963c](https://github.com/nevillionaire/puter/commit/9d5963cdf5fe63a4f7970d2d03bc307f4d4fa3ab))
* **puterai:** add togetherai ([bdfdf23](https://github.com/nevillionaire/puter/commit/bdfdf2331b37680b95ac56b31026d3bdab4c173b))
* **puterjs:** add drivers module ([439f52b](https://github.com/nevillionaire/puter/commit/439f52b5a3f1a94e6d15ddacc315ae797f4709c2))
* **putility:** trait method override support ([43c5402](https://github.com/nevillionaire/puter/commit/43c5402b7cb92e604cbe59badc8f735131d2c349))
* **readme:** add french readme respecting format and styling ([02e7e27](https://github.com/nevillionaire/puter/commit/02e7e27796d42e280c21529fe8386a2129761825))
* Reaload App option in the window title bar context menu ([27c01c9](https://github.com/nevillionaire/puter/commit/27c01c9bd991ef871153eb5931f78fec265a62e4))
* Require email confirmation before sharing ([cdd1a8c](https://github.com/nevillionaire/puter/commit/cdd1a8c4e379b885ff48a874ae5577d2f0efae06))
* search ([55d2af1](https://github.com/nevillionaire/puter/commit/55d2af189e9479fb5980ce149ce74e890b325014))
* search endpoint ([b589512](https://github.com/nevillionaire/puter/commit/b589512c9dedec22fd41b92cbba2570042149873))
* show unread notification count in the browser tab's title ([045259c](https://github.com/nevillionaire/puter/commit/045259cefbe24e3f52fe3840e4975d3243e99957))
* support readdir for directory symlinks ([7f1b870](https://github.com/nevillionaire/puter/commit/7f1b870d302421972c4f6221ae6d93b5979d51dd))
* the `socialLink` UI component ([1adfe5c](https://github.com/nevillionaire/puter/commit/1adfe5c70947d9de008c9d601f91b1ee14128d5d))
* translate README.md to Dutch ([31e2773](https://github.com/nevillionaire/puter/commit/31e2773743c336630c917e893b0148441f5fc515))
* v86 9p server support ([b145e30](https://github.com/nevillionaire/puter/commit/b145e30a90ff2f0d44d89f83dbda4de1bf2991d4))
* welcome screen to quickly explain what Puter is ([564ff65](https://github.com/nevillionaire/puter/commit/564ff65363258cab4196b967dd556105e424d48c))
* when sharing, users can choose between 'viewer' and 'editor' for permissions ([0cbe013](https://github.com/nevillionaire/puter/commit/0cbe0139d7f306ce62992f1eda94d99e09b32df8))


### Bug Fixes

* `launchApp` on explorer supports `~` now ([e482b00](https://github.com/nevillionaire/puter/commit/e482b00a303ca7ec0230be1924334d59adc00f8e))
* 1954f8-related issue ([f5865da](https://github.com/nevillionaire/puter/commit/f5865daede2b32682d0472926bc5db65c9ef37ab))
* 1954f8-related issue [#2](https://github.com/nevillionaire/puter/issues/2) ([143cfb5](https://github.com/nevillionaire/puter/commit/143cfb5654eca8b50fb7ff434f47db24d7bdf3aa))
* add env to EmitPlugin config ([4b89101](https://github.com/nevillionaire/puter/commit/4b8910169a26f85489135cd84b27fe8f91b37bc6))
* add missing id for task_manager menu item ([4f9d9a5](https://github.com/nevillionaire/puter/commit/4f9d9a54efb3c5177125904a1c9ddec66ca089dc))
* add mixxing context to BroadcastService ([665471f](https://github.com/nevillionaire/puter/commit/665471f9f02b1f1163edb47932a31f52577ee7df))
* add progress bar fix ([a70d0dd](https://github.com/nevillionaire/puter/commit/a70d0dd0881b0a07cea404fe13515a5e10321e3e))
* add username to comments ([085d808](https://github.com/nevillionaire/puter/commit/085d808817e985f2bc52b7a91a31991ca3b2e89f))
* allow ETX to propagate to bash ([259877b](https://github.com/nevillionaire/puter/commit/259877b677a7bfc8e5b377c8852d687978c9bc24))
* app close issue in phoenix ([38adb57](https://github.com/nevillionaire/puter/commit/38adb5741b241081dd3f30de2f9afdd708cc9fa5))
* app pseudonym in wrong conditional block ([9985996](https://github.com/nevillionaire/puter/commit/99859966866ebce005f88e3a916c68dc04ba97bf))
* attempt at fixing broadcast ([22dd42e](https://github.com/nevillionaire/puter/commit/22dd42ef7f64d32ada0c776287f53a80a4470315))
* Collector bug on undefined body ([14f477a](https://github.com/nevillionaire/puter/commit/14f477a6330c9169145a7f8b2721d02e7517513b))
* continue work on blocked_email_domains ([515051d](https://github.com/nevillionaire/puter/commit/515051dabf9f2a145ae2d090f829df7188e9fd28))
* continue work on blocked_email_domains (2) ([4dc1e01](https://github.com/nevillionaire/puter/commit/4dc1e01682571f16a25eebb2e9c7918587ca89ae))
* creating app shortcut in self-hosted ([38dcb60](https://github.com/nevillionaire/puter/commit/38dcb60d3f407dd185999d01d8e14355b47df0b8))
* disable thumbnails for AppData uploads ([37e7b6a](https://github.com/nevillionaire/puter/commit/37e7b6ad70f197db3be8712315446079caa23892))
* disabled sortable on sharing section in the sidebar ([9d7987f](https://github.com/nevillionaire/puter/commit/9d7987fae50b510f1836e306d5f6f497a560de08))
* dist ([ed7d6dc](https://github.com/nevillionaire/puter/commit/ed7d6dcbfbf432ae90d9e379dbf47de5587a57a2))
* **docker:** ensure temp admin pass shows ([d2c7477](https://github.com/nevillionaire/puter/commit/d2c7477b3bf170be492a6d5387330645cdf9c33a))
* don't access `metadata.credentialless` if it doesn't exist ([9590bbd](https://github.com/nevillionaire/puter/commit/9590bbdad1099cf75d6073663a9fcec5f3136482))
* don't allow sharing with recipient just shared with ([d0f16c8](https://github.com/nevillionaire/puter/commit/d0f16c810509c7e4e8acba3408c71655664cfad2))
* don't check share permission anymore ([249dc06](https://github.com/nevillionaire/puter/commit/249dc062014947c32bee8a8238b2c8acf86188bb))
* don't display all apps for extensionless files ([010282e](https://github.com/nevillionaire/puter/commit/010282edf299c2a39e53de7441b8850d0b8011b8))
* don't show kvstore in usages ([402ffb0](https://github.com/nevillionaire/puter/commit/402ffb0fd1e812a8db8ea90ac53ed613fdd30a4b))
* don't var when no var ([5f7d1f5](https://github.com/nevillionaire/puter/commit/5f7d1f589a56b3d3ea2026dcbd5f9c48b8dc9e6d))
* double-echo in phoenix ([6bdcae7](https://github.com/nevillionaire/puter/commit/6bdcae769d311b5deb82136d5e35d7ad986bca28))
* email change on account with unverified email ([33de981](https://github.com/nevillionaire/puter/commit/33de98107f6e3284acb180b1a44bb02ae082642f))
* env for dev build ([46a0f71](https://github.com/nevillionaire/puter/commit/46a0f714d10c2fa99ee9436f453176d54cc161f8))
* error deleting entry from My Websites window ([fff8993](https://github.com/nevillionaire/puter/commit/fff89932002d67bf0f121532709c871263e33473))
* error in process.handle_connection ([cb324cc](https://github.com/nevillionaire/puter/commit/cb324cc125285b5cd6a6b0cebf444a6cd873ded9))
* errors thrown by launch_app ([c22a69f](https://github.com/nevillionaire/puter/commit/c22a69ffb1809ad7959f8a8fe934052369b5d44f))
* fallback to read access in /sign ([813ee95](https://github.com/nevillionaire/puter/commit/813ee95cee6f1fca79a886b12d8fe4603ca0d213))
* files shared array in notification ([27cc07e](https://github.com/nevillionaire/puter/commit/27cc07e985a799fae791d6edf61b7e656e0e182e))
* fix 500 when check-app has bad url ([9a62200](https://github.com/nevillionaire/puter/commit/9a622004ea488783127abd83f3f4caf779a5aabb))
* fix sourcemap ([cd39bb5](https://github.com/nevillionaire/puter/commit/cd39bb5aa073286baa053f8458f0af54a4b7313a))
* groups manager location ([a08e975](https://github.com/nevillionaire/puter/commit/a08e9758fe7625d31279b8947a4e5ca6471578ff))
* height 100% on flexer and step view ([c6bc42f](https://github.com/nevillionaire/puter/commit/c6bc42f551a46919b4b70a9ae3dfec85086b0233))
* html-webpack-plugin dev dep ([cc4ab1c](https://github.com/nevillionaire/puter/commit/cc4ab1cb36a002929f26a39f252a262fc1f1aab4))
* hyphenize_confirm_code bug ([463c96c](https://github.com/nevillionaire/puter/commit/463c96c69a915ea75db66fd449e83a61ca036f6f))
* ignore invalid entries from service_usage_monthly ([f108795](https://github.com/nevillionaire/puter/commit/f1087953b57297a1e066ea68563e8a273a1af4c0))
* issue with context menu divider item stealing the event from previous item ([121043d](https://github.com/nevillionaire/puter/commit/121043d312577a6e048497108309cd08b73df4d0))
* issue with non-scrollable window body and document Context Menu ([0315cb3](https://github.com/nevillionaire/puter/commit/0315cb333719b08c6581b556c69a14cbe671b7bd))
* issue with popover closing when clicked ([ac3317a](https://github.com/nevillionaire/puter/commit/ac3317aea918953358947638ca11822baa38e23f))
* issue with service scripts that use TestView ([e0b9072](https://github.com/nevillionaire/puter/commit/e0b90721299fa3013f66c866ba637c52efe9df1d))
* issues in kdmod ([0a47daa](https://github.com/nevillionaire/puter/commit/0a47daa2896d97c318aec2e2288f61ade5f4ea48))
* ll_write ([a7cdb70](https://github.com/nevillionaire/puter/commit/a7cdb70251ae86f883257de3596838d20196c62d))
* logging in AppConnection ([5caa2c0](https://github.com/nevillionaire/puter/commit/5caa2c0e3a152d1fc947b86329778db462139db0))
* mistakes ([3092300](https://github.com/nevillionaire/puter/commit/3092300a0144791b25816b39845a3d85968e9059))
* mobile detection ([b11016d](https://github.com/nevillionaire/puter/commit/b11016dab321717f2c367e985167a4689fc02814))
* mobile-friendly taskbar ([7a7c14f](https://github.com/nevillionaire/puter/commit/7a7c14fb040b28ef769abdba41b50d88c856fb20))
* new sessions miss notifications ([b1ffb8e](https://github.com/nevillionaire/puter/commit/b1ffb8eca13520fa41833f5361ff6a6505a80a2c))
* notepad save issue ([bc51d4b](https://github.com/nevillionaire/puter/commit/bc51d4bd52b5d0a7bb4feddea7bb9d73e449f7d8))
* occasional db error from notics ([9e303a2](https://github.com/nevillionaire/puter/commit/9e303a2f7c7bf6ac9032e6c9b87bffd3126baa86))
* only add enabled_logs when not empty ([34836e3](https://github.com/nevillionaire/puter/commit/34836e374fccac297a6f0fa5f323f3609d0c9179))
* only allow UserActorType for ShareService ([69bfa60](https://github.com/nevillionaire/puter/commit/69bfa601993eb6c47c3555b92559878d76ba749e))
* persist clock visibility change ([1a6d648](https://github.com/nevillionaire/puter/commit/1a6d648a6ecdda07b23da9e6f4ef49b70b54cce1))
* phoenix incorrect lookup order ([c8f913d](https://github.com/nevillionaire/puter/commit/c8f913d710454d0ab3da2147309b442a78965720))
* prevent code from breaking just because it was bundled ([fb1216d](https://github.com/nevillionaire/puter/commit/fb1216d488bed8ee8d88c7c71e4a6f1054e3a01c))
* prevent permission cycles ([e0128aa](https://github.com/nevillionaire/puter/commit/e0128aa88c54548304532282e5ed1b4a2d36ff3e))
* properly add owner object to fsentries ([04c05a5](https://github.com/nevillionaire/puter/commit/04c05a5bb8b73dda21093a2bf563f5cd6faaa356))
* **puterai:** adapt message role for claude ([c08b897](https://github.com/nevillionaire/puter/commit/c08b897d4a6a77c54a7e8d2e705e2048ab4797ba))
* **puterai:** close streams ([eb18550](https://github.com/nevillionaire/puter/commit/eb18550f411947a0d8ccaf283701596b1386cfe6))
* **puterjs:** fix settings object check ([5a616f6](https://github.com/nevillionaire/puter/commit/5a616f67dd22a0dcbb8a380bbbd2347a0029ce31))
* quick patch to avoid columnify error ([4396534](https://github.com/nevillionaire/puter/commit/439653458eab38e622cf215ae96b6af34d1db7d4))
* reading JSON string from service_usage_monthly ([b30de5b](https://github.com/nevillionaire/puter/commit/b30de5bf786ae8f28f3248277c5b2df2f0e5ebf4))
* recently broke counting service sql ([7ba16d1](https://github.com/nevillionaire/puter/commit/7ba16d1c21d07e58cefebf967e5ca2b74502e841))
* reinitialize settings tabs for DOM events ([16b9f09](https://github.com/nevillionaire/puter/commit/16b9f09e66ffe1584f925cb1a9f261bc159c8dda))
* remove accidentally left-over code ([72946f9](https://github.com/nevillionaire/puter/commit/72946f920c9f27f4c9de3156aa9144d290699222))
* remove now-redundant loadScript call ([c9d09a7](https://github.com/nevillionaire/puter/commit/c9d09a78b6f4bc9682d13d2f982f9a2b7f77dd66))
* remove redundant openai model fallback ([9db55fc](https://github.com/nevillionaire/puter/commit/9db55fc5f7a975ab301c88bbac493b7a5b1933bb))
* replace ll_readshares with better approach ([cd22425](https://github.com/nevillionaire/puter/commit/cd22425a3d363f6008b3d07f40a082769ee22a14))
* report path for broken files as /-void/ ([5725bd8](https://github.com/nevillionaire/puter/commit/5725bd8c66539564e7f58f96c6e81044a3751f97))
* second half of connectToInstance ([4311b48](https://github.com/nevillionaire/puter/commit/4311b482fd629c6d1f65956eb711c8e890453179))
* **security:** always use actor ([1954f86](https://github.com/nevillionaire/puter/commit/1954f86680be642e1af03f648d6b587fe67dfaa8))
* **security:** remove unconfirmed_email from /whoami for apps ([a002ad0](https://github.com/nevillionaire/puter/commit/a002ad08e5622a349b5d24ed2c7c5f61215146b8))
* **security:** signing in public folders ([937528f](https://github.com/nevillionaire/puter/commit/937528f7676e8ace7287141e1f5057842a2b5eb7))
* service usage screen ([193da63](https://github.com/nevillionaire/puter/commit/193da633044f463ec1ed60eca4608761fc40b1d7))
* simplify callback listener and fix async bug ([db3e0b5](https://github.com/nevillionaire/puter/commit/db3e0b5ce84e4b0b35550f380da97b5d6fcb394b))
* small issue in Service.js ([3c5d2af](https://github.com/nevillionaire/puter/commit/3c5d2af8c8341ef78236ef38153ed0b4f20c5cac))
* temporary fix because .on can't call ensure_service ([f836ac3](https://github.com/nevillionaire/puter/commit/f836ac30a901a7b3258399a54eab5c7c8cc47463))
* thumbnail service updates ([c2a9506](https://github.com/nevillionaire/puter/commit/c2a9506b4855f67d320eb479a67800098d73e8ec))
* turns out we don't support `utm_source` I learn something new about Puter every day! ([99ce3bd](https://github.com/nevillionaire/puter/commit/99ce3bde199de729c4796a681c188c4a0da9165e))
* typo in a default file ([aa61c30](https://github.com/nevillionaire/puter/commit/aa61c3009c624099e7bd518870b18b02c008530c))
* un-awked notif check in wrong place ([3f3f4e6](https://github.com/nevillionaire/puter/commit/3f3f4e6cb9fd3faad2e87fbf9ea1f09b934151ca))
* update apps cache by reading from primary db ([e8f67da](https://github.com/nevillionaire/puter/commit/e8f67da9a3d81273f59d136c8383f00d9dc8ca5a))
* Update security.txt canonical URL ([6c44032](https://github.com/nevillionaire/puter/commit/6c44032293836871a27fb3c857a0ff3b80462702))
* upsert subdomain check to insert only ([f2acd83](https://github.com/nevillionaire/puter/commit/f2acd83b72c388939233fd7145f2dcf78d8ad39e))
* use correct cursor when hovering over sidebar items ([c44b9ab](https://github.com/nevillionaire/puter/commit/c44b9ab8d5f575393bf864fd30235287f845a4e8))
* use jq el for focus ([d350264](https://github.com/nevillionaire/puter/commit/d35026467eb9a5f67d6ec0c99f2a24d418b8e3a5))
* wait no ([12e0cec](https://github.com/nevillionaire/puter/commit/12e0cecf02f4d906035a6f0059557416475db106))
* webpack error reporting + unintentional whitespace changes ([4910838](https://github.com/nevillionaire/puter/commit/4910838ab1a72738b44f948cbf65feea848e5271))
